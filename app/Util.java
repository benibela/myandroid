...
public class Util {
    ...
    static public String tr(int id){
        if (myandroidApp.currentActivity == null) return "?tr?";
        else return tr(myandroidApp.currentActivity, id);
    }
    ...
    static public void showMessage(String message, String negative, String neutral, String positive, final MessageHandler handler){
        Context context = myandroidApp.currentActivity;
        if (context == null) return;
        AlertDialog.Builder builder = new AlertDialog.Builder(context);
        builder.setMessage(message);
        builder.setTitle("myandroid");
        if (negative != null)
    ...
    public static String formatDate(Date date){
        ...
        if (dateFormat == null && myandroidApp.currentActivity != null)
            dateFormat = android.text.format.DateFormat.getDateFormat(myandroidApp.currentActivity);
        if (dateFormat != null) return dateFormat.format(date);
    ...
    public static String formatDate(Bridge.SimpleDate date){
        ...
        if (Bridge.currentPascalDate > 0 && myandroidApp.currentActivity != null) {
